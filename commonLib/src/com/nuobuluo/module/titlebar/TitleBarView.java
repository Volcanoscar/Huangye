package com.nuobuluo.module.titlebar;
...
public class TitleBarView extends RelativeLayout {
    ...
    public void setBtnRightBg(int login_btn) {
        btnRight.setBackgroundResource(login_btn);

    }

    public void setBtnRightText(int add_user) {
        btnRight.setText(add_user);
