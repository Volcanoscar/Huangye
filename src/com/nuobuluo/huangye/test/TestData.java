package com.nuobuluo.huangye.test;



import com.nuobuluo.huangye.bean.RecentChat;
import com.nuobuluo.huangye.utils.FileUtiles;
...
public class TestData {
	...
	private static String dir= FileUtiles.getRecentChatPath();
	public static List<RecentChat> getRecentChats(){
		String path=FileUtiles.getRecentChatPath();
