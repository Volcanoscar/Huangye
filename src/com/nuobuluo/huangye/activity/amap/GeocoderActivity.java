...
import com.nuobuluo.huangye.utils.amap.ToastUtil;

/**
 * 地理编码与逆地理编码功能介绍
 */
public class GeocoderActivity extends AbstractTemplateActivity implements
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
        ...
        shopInfo = (ShopInfo) getIntent().getSerializableExtra("addInfo");
        latLonPoint = new LatLonPoint(Double.valueOf(shopInfo.getLat()), Double.valueOf(shopInfo.getLng()));
        init();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.daohang_action,menu);
        return true;
    }
    ...
    private void init() {
        if (aMap == null) {
            ...
            regeoMarker = aMap.addMarker(new MarkerOptions().anchor(0.5f, 0.5f).title(shopInfo.getAddress())
                    .icon(BitmapDescriptorFactory
